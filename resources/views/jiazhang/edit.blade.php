...
快捷方式：@can("create", new \App\Model\Role){!! link_to("jiazhang/create","增加家长") !!} | @endcan {!! link_to("jiazhang/$task->id","家长详情") !!} ||  @include("layouts.shortcut11")
</div>
...
<div class="panel-body">
{{ Form::model($task, ["url"=>"jiazhang/$task->id", "method" => "PUT", "class" => "form-horizontal"]) }}
<div class='panel panel-primary'>
<div class='panel-heading'>
必填项目
</div>
