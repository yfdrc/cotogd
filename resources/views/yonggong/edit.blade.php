...
@section('content')
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            快捷方式：@can("dianzhang", new \App\Model\Role){!! link_to("yonggong/create","增加员工") !!} | @endcan {!! link_to("yonggong/$task->id","员工详情") !!} ||  @include("layouts.shortcut12")
        </div>
        <div class="panel-body">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    {{ Form::model($task, ["url"=>"yonggong/$task->id", "method" => "PUT", "class" => "form-horizontal"]) }}
                    <div class='panel panel-primary'>
                        <div class='panel-heading'>
                            必填项目
                        </div>
